...
<body>
    <form id="frmActor" runat="server">
        ...
        <div class="mainTitle">
           ...
           <asp:Button ID="btnEditActor" runat="server" Text="Edit Actor" CssClass="buttonReview" OnClick="btnEditActor_Click" />
            <asp:Button ID="btnDeleteActor" runat="server" CssClass="buttonReview" Text="Delete Actor" OnClick="btnDeleteActor_Click" />
            ...
            <asp:Image ID="imgActorImage" runat="server" ImageUrl="https://resizing.flixster.com/VS2iCmn7Rsk7IQHAT1KBCwZ2oIE=/506x652/v2/https://flxt.tmsimg.com/v9/AllPhotos/57282/57282_v9_bb.jpg" Height="320" Width="240" />
            <div class="titleInfo">
                ...
                <asp:Repeater ID="rptActorRoles" runat="server">
                    ...
                    <ItemTemplate>     
                        <table style="width: 200px; height:200px;">
                            <tr>
                                <tr style="background-color: #343233">
                                    <td>
                                        <br />
                                        <table style="background-color: #343233;  width: 300px; height:20px; text-align:center;">
                                            <asp:ImageButton ID="imgRole" Height="220" Width="170" runat="server" ImageUrl='<%# Eval("titleImage") %>' OnCommand="Image_Click" CommandName="ImageClick" CommandArgument='<%# Eval("movieID") + "," + Eval("tvshowID") + "," + Eval("videoGameID") %>'></asp:ImageButton>
                                    </td>
                                </tr>
                        </table>
                            <td>
                                <table style="background-color: #343233; width: 600px; text-align:center;">
                                    <tr>
